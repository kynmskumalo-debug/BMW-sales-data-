...
Dataset contains columns with car details such as model, year, price, transmission, mileage, fue type, tax , mpg and engine size. This porject aims to create an analysis throug visualizations
...
Compares avergae prices between manual and automatic cars. (Note which transmission type has higher median price)
...
Test if larger engine sizes are associated with higher prices. Shows posotive correlation between engine size and price. 
...
Calculate the average price per year to estimate depreciation trends.Output shows decreasing prices as cars age.

<b>Fuel Effiecieny vs Engine Size</b>

Larger engines usually consume more fuel as they have lower MPG. Output note inverse relationship between engine size and mpg

<b>Tax vs Efficieny</b>

Check if higher tax rates are linked with less efficient cars.Output shows higher tax often for lower mpg cars. 
